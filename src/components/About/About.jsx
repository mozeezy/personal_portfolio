  ...
  return (
    <section id="about">
      ...
      <div className="container about__container">
        <p>
          My name is Mohamed and I am a full-stack web developer. Coming from a science background and after an unsuccessful bout of landing a job, I figured that it was time for a career switch. That is when I stumbled upon an opportunity to learn about software development and coding at Lighthouse Labs.
        </p>
        <br/>
        <BsThreeDots />
        <br />
        <p>Through my journey at Lighthouse Labs, I have built applications using various languages, libraries and tools such as JavaScript, HTML, CSS,SQL, Node.js, Express, React.js, jQuery, AJAX, PostgreSQL, and I am continuing to learn more. I'm currently enrolled in the Harvard CS50 course where I will be expanding on my coding skills by learning more languages, libraries, and frameworks.</p>
        <br />
        <BsThreeDots />
        <br />
